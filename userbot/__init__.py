...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/pisubot/Pis-Userbot")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "Pis-Userbot")
...
PIS_TEKS_KUSTOM = os.environ.get("PIS_TEKS_KUSTOM", None)
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Pis-Userbot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/785256129b0880d6e138b.jpg"
...
async def check_alive():
    await bot.send_file(BOTLOG_CHATID, ALIVE_LOGO, caption=f"**Pis Userbot Has Been Deployed✨**\n━━━━━━━━━━━━━━━━━\n**Bot Of:** {ALIVE_NAME}\n━━━━━━━━━━━━━━━━━\n**Support: **@pissupport\n━━━━━━━━━━━━━━━━━")
    return
                ...
                await ken.tgbot.send_file(event.chat_id, file=logo,
                                          ...
                                          buttons=[
                                              [
                                                  custom.Button.url(
                                                      text="Rᴇᴘᴏ",
                                                      url="https://github.com/pisubot/Pis-Userbot"),
                                                  custom.Button.url(
                                                      text="Lɪsᴇɴsɪ​",
                                                      url="https://github.com/pisubot/PIS-USERBOT/blob/PIS-USERBOT/LICENSE"
                                                  )
                                              ]
                                          ]
                                          )
